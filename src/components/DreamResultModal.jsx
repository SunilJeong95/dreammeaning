...
const COLOR_MAP = {
  ...
  gold:
  { text: 'text-amber-400',  dot: 'bg-amber-500',  glow: 'bg-amber-500/10',  shadow: '0 0 10px rgba(245,158,11,0.5)'  },
...
// Radar chart: 5 corners for [fortune, creativity, stress, realism, nightmare]
...
export default function DreamResultModal({ result, onClose }) {
  ...
  // Split title: last 2 words get gradient
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-start py-4 overflow-auto bg-[#020617]/90 backdrop-blur-sm">

      {/* Mobile card */}
      <div className="w-full max-w-[450px] mx-4 flex flex-col shadow-2xl rounded-[2.5rem] bg-[#020617] border border-slate-800 ring-1 ring-white/5 overflow-hidden font-display">

        {/* Header */}
        <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 bg-[#020617]/80 backdrop-blur-md border-b border-slate-800/50">
          <button
            onClick={onClose}
        ...
        <main className="flex flex-col p-6 gap-8">
          ...
          <section className="flex flex-col gap-6">
            <div className={`relative w-full aspect-square rounded-2xl overflow-hidden border border-[#1ed8f1]/30 shadow-neon bg-gradient-to-br ${gradient}`}>
            ...
            <>
              ...
              <section className="relative rounded-2xl overflow-hidden border border-slate-800 bg-surface-dark p-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-slate-300 leading-relaxed blur-[4px] select-none">{result.deepAnalysis}</p>
                  <p className="text-sm text-slate-300 leading-relaxed blur-[8px] select-none">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#020617]/80 to-[#020617] flex flex-col items-center justify-end pb-6 pt-20">
                  ...
                  <button className="w-[90%] bg-[#1ed8f1] hover:bg-[#158ca1] text-[#020617] font-bold py-3.5 px-6 rounded-full shadow-neon transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2">
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-surface-dark border border-slate-800 p-4 rounded-2xl flex flex-col justify-between h-28 relative overflow-hidden group">
                  ...
                  <div
                    className={`w-4 h-4 rounded-full absolute bottom-4 right-4 ${colorStyle.dot}`}
                    style={{ boxShadow: colorStyle.shadow }}
                  />
                </div>
      ...
      {/* Background glows */}
      <div className="fixed top-20 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#1ed8f1]/5 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="fixed bottom-0 left-1/4 w-[400px] h-[400px] bg-[#a855f7]/5 rounded-full blur-[100px] pointer-events-none -z-10" />
    </div>
  );
}
